...
public class MoneyTimeRateTest extends TestCase {
  public void testSimpleRate() {
    ...
    Assert.assertEquals(Money.dollars(40.00), rate.over(Duration.hours(2)));
  }
  ...
  public void testRoundingRate() {
    ...
    Assert.assertEquals(Money.euros(new BigDecimal("33.33")), rate.over(Duration.minutes(1), Rounding.DOWN));
  }
  ...
  public void testRoundingScalingRate() {
    ...
    Assert.assertEquals(Money.euros(new BigDecimal("33.33")), rate.over(Duration.minutes(1), 2, Rounding.DOWN));
  }
