...
public class IntervalTest extends TestCase {
	...
	Interval empty = Interval.open(new BigDecimal(1), new BigDecimal(1));
	Interval c5_10c = Interval.closed(new BigDecimal(5),new BigDecimal(10));
    Interval c1_10c = Interval.closed(new BigDecimal(1),new BigDecimal(10));
    Interval c4_6c = Interval.closed(new BigDecimal(4),new BigDecimal(6));
    Interval c5_15c = Interval.closed(new BigDecimal(5),new BigDecimal(15));
    Interval c12_16c = Interval.closed(new BigDecimal(12),new BigDecimal(16));
    Interval o10_12c = Interval.over(new BigDecimal(10), false, new BigDecimal(12), true);

	Interval o1_1c = Interval.over(new BigDecimal(1), false, new BigDecimal(1), true);
	Interval c1_1o = Interval.over(new BigDecimal(1), true, new BigDecimal(1), false);
	Interval c1_1c = Interval.over(new BigDecimal(1), true, new BigDecimal(1), true);
	Interval o1_1o = Interval.over(new BigDecimal(1), false, new BigDecimal(1), false);
...
//	}
    ...
    public void testSerialization() {
    	SerializationTest.assertSerializationWorks(c5_10c);
    }
