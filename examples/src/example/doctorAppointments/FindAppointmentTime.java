...
public class FindAppointmentTime extends TestCase {
	...
	/**
	 * AppointmentCalendar can have IntervalKeyedMap of Appointments. Adding an appointment
	 * calls for checking if the Map has an intersecting key.
	 * IntervalSequence could intersect with an interval returning another IntervalSequence.
	 * The IntervalSequence could also iterate through its gaps (which are intervals). This
	 * would be the complement of the IntervalSequence.
	 * Then finding an appointment time is taking the intersection of the desired interval
	 * with the IntervalSequence of the keys, then taking the complement of that, then asking
	 * for the iterator of Duration matching desired appointment duration.
	 * 
